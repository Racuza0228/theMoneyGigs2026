      ...
      builder: (context, demoProvider, child) {
        ...
        return Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            // colorScheme.primary, which is a purple auto-generated by the
            // deepPurple ColorScheme.fromSeed() below. That purple was
            // coincidentally also showing up as an arbitrary avatar-circle
            // color elsewhere (gig_list_tile.dart), making it read like two
            // unrelated things shared one color by accident. Orange is now
            // the one intentional accent used for nav highlight, buttons,
            // and badges app-wide.
